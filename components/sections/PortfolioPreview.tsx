  ...
  return (
    <section className="section-padding" style={{ borderBottom: '1px solid var(--border-2)' }}>
      <div className="container">
        <p className="text-label mb-2">Próximo caso de éxito</p>
        <div
          className="grid grid-cols-1 md:grid-cols-2 gap-0"
          style={{ border: '1px solid var(--border)' }}
        >
          <div className="p-8" style={{ borderRight: '1px solid var(--border)', background: 'var(--black-2)' }}>
            <div className="text-label mb-3" style={{ color: 'var(--red)' }}>En construcción · Próximamente</div>
            <h3 className="text-d3 mb-4">Casos de<br />Éxito</h3>
            <p style={{ fontSize: 13, color: 'var(--gray-2)', lineHeight: 1.8, marginBottom: 24 }}>
              Estamos documentando los primeros proyectos de BLITZ. Negocios salvadoreños que ya
              automatizan su atención al cliente con agentes IA funcionando 24/7.
            </p>
            <div className="flex gap-6 mb-6">
              {[['5', 'Agentes'], ['24/7', 'Operación'], ['IA', 'Integrada']].map(([n, l]) => (
                <div key={l}>
          ...
          <div className="p-8 flex items-center justify-center" style={{ background: 'var(--black)', minHeight: 200 }}>
            <div className="text-center">
              ...
              <div className="flex gap-2 justify-center flex-wrap">
                {['Next.js 15', 'Claude Haiku', 'Vercel', 'WhatsApp API'].map((t) => (
