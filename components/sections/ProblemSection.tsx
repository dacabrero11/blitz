...
const PROBLEMS = [
  ...
  { n: '02', title: 'Una página web estática no vende.', desc: 'Tener presencia digital no es suficiente. Necesitas una web que convierta visitantes en clientes reales.' },
  { n: '03', title: 'Contratar personal es caro y lento.', desc: 'Un agente de IA hace el trabajo de 3 empleados a una fracción del costo, sin renunciar los lunes.' },
  { n: '04', title: 'No sabes qué pasa con tus datos.', desc: 'Sin análisis en tiempo real, tomas decisiones a ciegas. Tus competidores ya saben lo que tú ignoras.' },
]
